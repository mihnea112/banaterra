	...
	<body>
		...
		<section class="autori">
			<div class="container">
				...
				<div class="row">
					<div class="col-md-3 col-lg-3 col-sm-6 col-6 autor autor-born-died no-border news-font">
						<img src="images/test.jpg" alt="{AUT NAME}" />
						<span class="citate"><br>x citate</span>
						<h5>Stendhal</h5>
						<p>
